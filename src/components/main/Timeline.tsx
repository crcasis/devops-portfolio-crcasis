...
export const timelineData: TimelineItem[] = [
  {
    ...
    imageURL: '/site-guru-logo.png',
    description:
      'Building responsive, high-performance Vue.js applications with seamless API integration and modern UI/UX best practices.',
    achievements: [
      'Developed reusable Vue.js components with Vuetify 2.',
      'Integrated REST APIs with Vuex for robust state management.',
