...
//   { skill_name: 'Datadog', Image: '/next.png', width: 80, height: 80 },
//   { skill_name: 'Linux', Image: '/redux.png', width: 80, height: 80 },
//   { skill_name: 'Nginx', Image: '/reactquery.png', width: 80, height: 80 },
//   { skill_name: 'Jira', Image: '/tailwind.png', width: 80, height: 80 },
//   { skill_name: 'GitLab', Image: '/gitlab.png', width: 80, height: 80 },
//   { skill_name: 'Node.js', Image: '/node-js.png', width: 80, height: 80 },
//   { skill_name: 'GCloud', Image: '/express.png', width: 80, height: 80 },
//   { skill_name: 'Azure', Image: '/spring-boot.png', width: 55, height: 55 },
//   { skill_name: 'PostgreSQL', Image: '/postger.png', width: 70, height: 70 },
//   { skill_name: 'MySQL', Image: '/mysql.png', width: 70, height: 70 },
//   { skill_name: 'Ansible', Image: '/prisma.webp', width: 70, height: 70 },
//   { skill_name: 'Redhat', Image: '/graphql.png', width: 80, height: 80 },
...
//   { skill_name: 'Confluence', Image: '/rust.png', width: 70, height: 70 },
//   { skill_name: 'Zabbix', Image: '/go.png', width: 60, height: 60 },
//   { skill_name: 'CloudFlare', Image: '/cloudflare.png', width: 80, height: 80 },
...
export const skills: Skill[] = [
  ...
  { skill_name: 'Spring Boot', Image: '/spring-boot.png', width: 55, height: 55 },
  { skill_name: 'PostgreSQL', Image: '/postger.png', width: 70, height: 70 },
  { skill_name: 'MySQL', Image: '/mysql.png', width: 70, height: 70 },
  ...
  { skill_name: 'Kubernetes', Image: '/kubernetes.png', width: 50, height: 50 },
  { skill_name: 'AWS', Image: '/aws.png', width: 70, height: 70 },
  { skill_name: 'Rust', Image: '/rust.png', width: 70, height: 70 },
